...
@section('content')
    ...
    <header>
        ...
        <nav>
            <a href="{{ route('funcionario.estoque') }}">Estoque</a>
            <a href="{{ route('funcionario.fornecedor') }}">Fornecedor</a>
            <a href="{{ route('funcionario.clientes') }}">Clientes</a>
            <a href="{{ route('funcionario.pedidos') }}">Pedidos</a>
            <a href="{{ route('funcionario.produtos') }}">Produtos</a>
        </nav>
    </header>
    ...
    <section class="hero">
        <h1>📦 Novo Pedido</h1>
        <p>Preencha os dados do pedido para adicionar ao sistema</p>
    </section>

    <!-- Form Section -->
    <div class="container">
        <h2 class="section-title">📋 Cadastro de Pedido</h2>

        <div style="max-width: 600px; margin: 0 auto;">
            <form action="{{ route('funcionario.pedido.store') }}" method="POST" style="background: linear-gradient(160deg, rgba(220,245,255,0.85) 0%, rgba(200,240,220,0.75) 50%, rgba(180,230,210,0.65) 100%); border-radius: 24px; padding: 40px; border: 1.5px solid rgba(255,255,255,0.7); box-shadow: 0 8px 32px rgba(80,160,200,0.15), inset 0 2px 0 rgba(255,255,255,0.85);">
                @csrf

                <div style="margin-bottom: 24px;">
                    <label for="data_pedido" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Data do Pedido</label>
                ...
                <div style="margin-bottom: 24px;">
                    <label for="cliente_nome" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Nome do Cliente</label>
                    <input type="text" id="cliente_nome" name="cliente_nome" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="status" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Status</label>
                    <select id="status" name="status" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;">
                ...
                <div style="margin-bottom: 24px;">
                    <label for="data_entrega" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Data de Entrega (Opcional)</label>
                    <input type="date" id="data_entrega" name="data_entrega" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="valor_total" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Valor Total</label>
                    <input type="number" id="valor_total" name="valor_total" required step="0.01" min="0" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="endereco_entrega" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Endereço de Entrega</label>
                    <input type="text" id="endereco_entrega" name="endereco_entrega" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 30px;">
                    <label for="observacoes" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Observações (Opcional)</label>
                    <textarea id="observacoes" name="observacoes" rows="4" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease; resize: vertical;"></textarea>
                </div>

                <div style="display: flex; gap: 16px;">
                    <button type="submit" class="glossy-btn" style="flex: 1; margin-top: 0; text-align: center;">✨ Adicionar Pedido</button>
                    <a href="{{ route('funcionario.pedido.index') }}" style="flex: 1; padding: 14px 36px; font-size: 16px; font-weight: 700; color: #fff; background: linear-gradient(180deg, #b0b0b0 0%, #7a7a7a 100%); border: 1.5px solid rgba(255,255,255,0.4); border-radius: 30px; text-decoration: none; box-shadow: 0 6px 20px rgba(122,122,122,0.3), inset 0 2px 0 rgba(255,255,255,0.4); text-align: center; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;">← Voltar</a>
                </div>
            </form>
        </div>
    </div>
