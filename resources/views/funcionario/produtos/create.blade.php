...
@section('content')
    ...
    <section class="hero">
        <h1>🌿 Novo Produto</h1>
        <p>Preencha os dados do produto para adicionar ao sistema</p>
    </section>
    ...
    <div class="container">
        ...
        <div style="max-width: 600px; margin: 0 auto;">
            <form action="{{ route('funcionario.produto.store') }}" method="POST" style="background: linear-gradient(160deg, rgba(220,245,255,0.85) 0%, rgba(200,240,220,0.75) 50%, rgba(180,230,210,0.65) 100%); border-radius: 24px; padding: 40px; border: 1.5px solid rgba(255,255,255,0.7); box-shadow: 0 8px 32px rgba(80,160,200,0.15), inset 0 2px 0 rgba(255,255,255,0.85);">
                @csrf

                <div style="margin-bottom: 24px;">
                    <label for="nome" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Nome</label>
                    <input type="text" id="nome" name="nome" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="descricao" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Descrição</label>
                    <textarea id="descricao" name="descricao" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;"></textarea>
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="preco" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Preço</label>
                    <input type="number" id="preco" name="preco" step="0.01" min="0" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>
                ...
                <div style="margin-bottom: 24px;">
                    <label for="tamanho" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Tamanho</label>
                    <select id="tamanho" name="tamanho" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;">
                ...
                <div style="margin-bottom: 24px;">
                    <label for="cor" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Cor</label>
                    <input type="text" id="cor" name="cor" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="material" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Material</label>
                    <select id="material" name="material" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;">
                        <option value="">Selecione</option>
                ...
                <div style="margin-bottom: 24px;">
                    <label for="categoria" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Categoria</label>
                    <input type="text" id="categoria" name="categoria" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 30px;">
                    <label for="ativo" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Ativo</label>
                    <select id="ativo" name="ativo" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;">
                        <option value="">Selecione</option>
