    ...
    <div class="container">
        ...
        <div style="max-width: 600px; margin: 0 auto;">
            <form action="{{ route('funcionario.fornecedor.store') }}" method="POST" style="background: linear-gradient(160deg, rgba(220,245,255,0.85) 0%, rgba(200,240,220,0.75) 50%, rgba(180,230,210,0.65) 100%); border-radius: 24px; padding: 40px; border: 1.5px solid rgba(255,255,255,0.7); box-shadow: 0 8px 32px rgba(80,160,200,0.15), inset 0 2px 0 rgba(255,255,255,0.85);">
                ...
                <div style="margin-bottom: 24px;">
                    <label for="email" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Email</label>
                ...
                <div style="margin-bottom: 24px;">
                    <label for="telefone" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Telefone</label>
                    <input type="tel" id="telefone" name="telefone" required placeholder="(00) 00000-0000" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="cnpj" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">CNPJ</label>
                    <input type="text" id="cnpj" name="cnpj" required placeholder="00.000.000/0000-00" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="endereco" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Endereço</label>
                    <input type="text" id="endereco" name="endereco" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="margin-bottom: 24px; display: grid; grid-template-columns: 2fr 1fr; gap: 16px;">
                    <div>
                        <label for="cidade" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Cidade</label>
                        <input type="text" id="cidade" name="cidade" required style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                    </div>
                    <div>
                        <label for="estado" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">Estado</label>
                        <input type="text" id="estado" name="estado" required maxlength="2" placeholder="SP" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                    </div>
                </div>

                <div style="margin-bottom: 30px;">
                    <label for="cep" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">CEP</label>
                    <input type="text" id="cep" name="cep" required placeholder="00000-000" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>

                <div style="display: flex; gap: 16px;">
                    <button type="submit" class="glossy-btn" style="flex: 1; margin-top: 0; text-align: center;">✨ Adicionar Fornecedor</button>
                    <a href="{{ route('funcionario.fornecedor.index') }}" style="flex: 1; padding: 14px 36px; font-size: 16px; font-weight: 700; color: #fff; background: linear-gradient(180deg, #b0b0b0 0%, #7a7a7a 100%); border: 1.5px solid rgba(255,255,255,0.4); border-radius: 30px; text-decoration: none; box-shadow: 0 6px 20px rgba(122,122,122,0.3), inset 0 2px 0 rgba(255,255,255,0.4); text-align: center; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;">← Voltar</a>
                </div>
            </form>
        </div>
    </div>
