...
@section('content')
    ...
    <section class="hero">
        <h1>🌿 Novo Cliente</h1>
        <p>Preencha os dados do cliente para adicionar ao sistema</p>
    </section>
    ...
    <div class="container">
        ...
        <div style="max-width: 600px; margin: 0 auto;">
            <form action="{{ route('clientes.store') }}" method="POST" style="background: linear-gradient(160deg, rgba(220,245,255,0.85) 0%, rgba(200,240,220,0.75) 50%, rgba(180,230,210,0.65) 100%); border-radius: 24px; padding: 40px; border: 1.5px solid rgba(255,255,255,0.7); box-shadow: 0 8px 32px rgba(80,160,200,0.15), inset 0 2px 0 rgba(255,255,255,0.85);">
                ...
                <div style="margin-bottom: 24px;">
                    <label for="cpf" style="display: block; font-weight: 700; color: #3a8a6a; margin-bottom: 8px; font-size: 14px; text-transform: uppercase; letter-spacing: 0.8px;">CPF</label>
                    <input type="text" id="cpf" name="cpf" required placeholder="000.000.000-00" style="width: 100%; padding: 12px 16px; border: 1.5px solid rgba(255,255,255,0.5); border-radius: 12px; font-size: 15px; background: linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(220,245,235,0.4) 100%); color: #1e5a44; font-weight: 600; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); transition: all 0.3s ease;" />
                </div>
